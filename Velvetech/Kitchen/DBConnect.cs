...
namespace Velvetech
{
    ...
    {
        public readonly static string StaticConnectionStringDB = ConfigurationManager.ConnectionStrings["velvetech"].ConnectionString;
        protected string ConnectionStringDB = ConfigurationManager.ConnectionStrings["velvetech"].ConnectionString;
        ...
        {
            using (var db = new SqlConnection(ConnectionStringDB))
            {
        ...
        {
            using (var db = new SqlConnection(StaticConnectionStringDB))
            {
